...
public:
    ...
    Vec2 getSeekPosition(Vec2 position,Vec2 targetPosition, Vec2& characterVelocity);
    Vec2 getPursuitPosition(Vec2 position,Vec2 targetPosition, Vec2& targetVelocity);
    Vec2 velocity;
    Vec2 velocity2;
