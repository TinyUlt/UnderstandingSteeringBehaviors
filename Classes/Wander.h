...
//    void update(float dt);
//    
//    Vec2 getWanderSteering(Vec2 characterPosition,Vec2 targetPosition, Vec2& characterVelocity, Vec2& wanderForce);
//    Vec2 getWanderPosition(Vec2 characterPosition,Vec2 targetPosition, Vec2& characterVelocity, Vec2& wanderForce);
//    
//    Vec2 velocity;
