...
public:
    ...
    static Vec2 getWanderSteering(Vec2 characterPosition,Vec2 targetPosition, Vec2& characterVelocity, Vec2& wanderForce);
    static Vec2 getWanderPosition(Vec2 characterPosition,Vec2 targetPosition, Vec2& characterVelocity, Vec2& wanderForce);
